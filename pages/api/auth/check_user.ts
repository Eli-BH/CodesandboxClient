...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        let foundUser = await pool.query('SELECT FirstName, LastName, Birthdate,Sfid, Email, caller_type_c, Primary_Language__c, Phone, RecordTypeId, MailingCity, MailingPostalCode, MailingState, MailingStreet FROM salesforce.Contact WHERE Email = $1', [email])
